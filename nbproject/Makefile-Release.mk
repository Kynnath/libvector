...
${OBJECTDIR}/src/VEC/Vector2.o: src/VEC/Vector2.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -s -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/VEC/Vector2.o src/VEC/Vector2.cpp

${OBJECTDIR}/src/VEC/Vector3.o: src/VEC/Vector3.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/VEC
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -s -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/VEC/Vector3.o src/VEC/Vector3.cpp
