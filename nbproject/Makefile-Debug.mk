...
${TESTDIR}/src/tests/VectorTest.o: src/tests/VectorTest.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -Iinclude -I. -std=c++11 -MMD -MP -MF $@.d -o ${TESTDIR}/src/tests/VectorTest.o src/tests/VectorTest.cpp
...
${OBJECTDIR}/src/Vector2_nomain.o: ${OBJECTDIR}/src/Vector2.o src/Vector2.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -Wall -Iinclude -std=c++11 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Vector2_nomain.o src/Vector2.cpp;\
	else  \
...
${OBJECTDIR}/src/Vector3_nomain.o: ${OBJECTDIR}/src/Vector3.o src/Vector3.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -Wall -Iinclude -std=c++11 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Vector3_nomain.o src/Vector3.cpp;\
	else  \
